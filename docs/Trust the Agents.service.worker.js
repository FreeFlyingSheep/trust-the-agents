...
/** @type {string} */
const CACHE_VERSION = '1775724660|37760678626';
/** @type {string} */
const CACHE_PREFIX = 'Trust the Agents-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'Trust the Agents.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["Trust the Agents.html","Trust the Agents.js","Trust the Agents.offline.html","Trust the Agents.icon.png","Trust the Agents.apple-touch-icon.png","Trust the Agents.audio.worklet.js","Trust the Agents.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["Trust the Agents.wasm","Trust the Agents.pck"];
